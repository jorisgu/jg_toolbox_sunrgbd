function I = DEA(a_d_raw, intrinsic_source, data_path, name, ext)
% a_d_raw : depth in mm

% DEA : depth / entropy / angle
...
[~, N, yDir, ~, ~, ~] = processDepthImage(D*100, missingMask, K); % depth in cm
